...
const classes = {
  ...
  item: 'margin-1 padding-1 flex wrap justify-center',
  ...
  itemColumnThree: 'mobile-self-center mobile-flex mobile-wrap mobile-justify-center mobile-margin-top-3 mobile-align-center desktop-align-right desktop-width-third',
